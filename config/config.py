...
def init_test_mot17():
    ...
    config['mot_root'] = '/media/ray/Data/LAB/project/NTUST_plate/MOT/plate'
    config['save_folder'] = '/media/ray/Data/LAB/project/NTUST_plate/MOT/SST/results'
    config['log_folder'] = '/media/ray/Data/LAB/project/NTUST_plate/MOT/SST/Log'
    config['batch_size'] = 1
...
def init_train_mot17():
    ...
    config['log_folder'] = '/media/ray/Data/LAB/project/NTUST_plate/MOT/SST/Log'
    config['save_folder'] = '/media/ray/Data/LAB/project/NTUST_plate/MOT/SST/results'
    config['save_images_folder'] = '/media/ray/Data/LAB/project/NTUST_plate/MOT/SST/results/img'
    config['type'] = 'train'
    config['resume'] = None  # None means training from sketch.
    config['detector'] = 'DPM'
    config['start_iter'] = 0
    config['iteration_epoch_num'] = 12
...
def init_train_mot15():
    ...
    config['resume'] = None
    config['video_name_list'] = ['Rain','Day_082040_881','Day_ARFH0487','Night_ARFH0256']
    config['start_iter'] = 0
...
def init_test_mot15_train_dataset():
    ...
    config['type'] = 'train'
    config['dataset_type'] = 'train'
    config['Rain','Day_082040_881','Day_ARFH0487','Night_ARFH0256']
